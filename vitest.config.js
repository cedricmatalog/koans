...
export default defineConfig({
  test: {
    ...
    include: [
      ...
      'koans/28_about_dates.test.js',
      'koans/29_about_callbacks.test.js',
      'koans/30_about_promises.test.js',
      'koans/31_about_async_await.test.js',
      'koans/32_about_event_loop.test.js',
    ],
    bail: 1,
